<template>
  <div>
    ...
    <!-- <button class="payment" @click="formflg = false">支出</button>
    <button class="income" @click="formflg = true">収入</button> -->

    <!-- <form v-show="formflg" id="contact">
      <div class="container">
        <div class="head">
          <h2>収入内容</h2>
        </div>
        <select v-model="incomeGenru">
          <option value="未分類" selected>未分類</option>
          <option value="給与">給与</option>
          <option value="その他">その他</option></select
        ><br />
        <input v-model="incomeDate" type="date" name="date" /><br />
        <input
          v-model="income"
          type="text"
          name="cost"
          placeholder="金額"
        /><br />
        <input v-model="incomePayee" type="text" placeholder="受け取り先" />
        <textarea
          v-model="incomeMemo"
          type="text"
          name="memo"
        ...
        <button
          id="submit"
          class="income-register"
          type="submit"
          @click.prevent="resisterIncome"
        >
          登録
        </button>
      </div>
    ...
    <!-- <form v-show="!formflg" id="contact">
      <div class="container">
        ...
        <select v-model="paymentGenru">
          ...
          <option value="その他">その他</option></select
        ><br />
        <input v-model="paymentDate" type="date" name="date" /><br />
        <input
          v-model="cost"
          type="text"
          name="cost"
        ...
        <button
          id="submit"
          class="payment-register"
          type="submit"
          @click.prevent="resisterPayment"
        >
          登録
        </button>
      </div>
